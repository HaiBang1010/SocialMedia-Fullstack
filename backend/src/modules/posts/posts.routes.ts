...
import { createCommentSchema, commentListQuerySchema } from '../comments/comments.schema';
...
/**
 * GET /posts/:id/comments — list ROOT comments (newest first, cursor pagination),
 * each with repliesCount. Replies load lazily via GET /comments/:id/replies.
