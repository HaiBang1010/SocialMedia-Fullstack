...
| 6. Calls (Audio+Video 1-1 + group, LiveKit Cloud SFU; Call-as-Message; 4 REST + 3 socket events; webhook defer) | 🔨 Code done — live browser smoke (2 user + LiveKit dashboard) + `public/sounds/ringtone.mp3` pending |
| 7. Polish (notifications, search, hide bài, bảo mật) | Chưa bắt đầu |
