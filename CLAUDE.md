...
| 5.4b Messaging Voice messages | Chưa bắt đầu |
| 5.4c Messaging Sticker/GIF-picker + Post share | Chưa bắt đầu |
| 5.5 Messaging recall (soft-delete) + reply-to + group management UI | Chưa bắt đầu |
| 6-7 | Chưa bắt đầu |
